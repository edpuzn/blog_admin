<template>
  ...
  <form @submit.prevent = "submit">
    ...
    <div class="form-group row">
      <label class="col-sm-2 col-form-label">Yeni Blog Görseli</label>
      <div class="col-sm-10">
